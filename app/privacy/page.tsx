      ...
      <main className="max-w-4xl mx-auto px-6 pt-32 pb-20">
        ...
        <div className="space-y-8 text-xs text-white/70 leading-relaxed border-t border-white/[0.08] pt-8">
          <section className="space-y-3">
            ...
            <p>
              Abishek Tech (&ldquo;we&rdquo;, &ldquo;our&rdquo;, or &ldquo;us&rdquo;) respects your privacy and is committed to protecting visitor personal data. This Privacy Policy explains how information is collected, used, and safeguarded when visiting www.abishektech.online.
            </p>
          </section>
